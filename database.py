...
def init_db():
    ...
    # Agar shifokorlar jadvali bo'sh bo'lsa, namuna ma'lumot qo'shamiz
    cur.execute("SELECT COUNT(*) as cnt FROM doctors")
    if cur.fetchone()["cnt"] == 0:
        sample_doctors = [
            ("Aziza Karimova", "Terapevt", "101", 50000),
            ("Bobur Toshev", "Stomatolog", "102", 80000),
            ("Dilnoza Yusupova", "Pediatr", "103", 60000),
        ]
        cur.executemany(
